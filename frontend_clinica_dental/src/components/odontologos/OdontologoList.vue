    ...
    <table>
      ...
      <tbody>
        <tr v-for="(odontologo, index) in odontologos" :key="odontologo.id">
          ...
          <td>
            <Button icon="pi pi-pencil" aria-label="Editar" text @click="emitirEdicion(odontologo)" />
            <Button icon="pi pi-trash" aria-label="Eliminar" text @click="mostrarEliminarConfirm(odontologo)" />
          </td>
        </tr>
      </tbody>
    </table>

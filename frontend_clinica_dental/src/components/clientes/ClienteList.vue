  ...
  <div>
    <div v-if="cliente" class="card flex flex-column gap-4">
      <div class="flex items-center gap-4 mb-4">
        ...
        <InputText id="nombre" :value="cliente.nombre" disabled class="flex-auto" />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="primer_apellido" class="font-semibold w-24">Primer <br />
          Apellido</label>
        <InputText id="primer_apellido" :value="cliente.primerApellido" disabled class="flex-auto" />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="segundo_apellido" class="font-semibold w-24">Segundo Apellido</label>
        <InputText id="segundo_apellido" :value="cliente.segundoApellido" disabled class="flex-auto" />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="email" class="font-semibold w-24">Correo</label>
        <InputText id="email" :value="cliente.email" disabled class="flex-auto" />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="telefono" class="font-semibold w-24">Teléfono</label>
        <InputText id="telefono" :value="cliente.telefono" disabled class="flex-auto" />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="direccion" class="font-semibold w-24">Dirección</label>
        <InputText id="direccion" :value="cliente.direccion" disabled class="flex-auto" />
      </div>
